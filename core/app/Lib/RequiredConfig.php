...
class RequiredConfig{
    ...
    public function getConfig(){
        return [
            ...
            'ad_type' => [
                'title'=>'Add at-least one Ad type',
                'route'=>route('admin.advertise.type')
            ],
            'add_country' => [
                'title'=>'Add at-least one country',
                'route'=>route('admin.country.list')
            ],
            'advertiser_plan' => [
                'title'=>'Add at-least one advertiser plan',
                'route'=>route('admin.advertise.plan.price')
            ],
            'add_cost' => [
                'title'=>'Add advertising cost for at-least one country',
                'route'=>route('admin.advertise.per.cost')
            ],
        ];
    }
